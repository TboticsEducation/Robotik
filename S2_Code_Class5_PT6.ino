...
uint8_t const PROGMEM RemoteXY_CONF_PROGMEM[] =   // 46 bytes V19 
  { 255,2,0,0,0,39,0,19,0,0,0,0,31,1,106,200,1,1,2,0,
  10,22,62,24,24,48,4,26,31,79,78,0,31,79,70,70,0,1,60,62,
  24,24,0,2,31,0 };
...
void loop() {
  ...
  // kontrol LED dengan pushSwitch_01
  ...
  // kontrol buzzer dengan button_01
